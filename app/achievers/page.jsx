                  ...
                  >
                    ...
                    >
                      <div className="flex max-sm:flex-col sm:flex-row md:flex-col lg:flex-row space-x-5 items-center  text-start transition-all duration-300 ease-in-out hover:scale-105">
                        <div className="w-20 h-20 sm:w-32 sm:h-32 md:w-40 md:h-40 flex-shrink-0 ring-2 ring-[#bf213e] ring-offset-2 rounded-full overflow-hidden bg-gray-200 relative">
                          <Image
                            src={a.image}
                            alt={a.name}
                            width={1000}
...
//         <h2 className="text-2xl text-[#b12f3e]">Error loading achievers</h2>
